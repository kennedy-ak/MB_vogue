"""
Django settings for MB_vogue project.
...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-$wak#a0l2*l#kf_ngi5vvg%tu3md=oj+i&d(&@ge(x^21bm8!b')
...
WSGI_APPLICATION = 'MB_vogue.wsgi.application'
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:8000",
    "http://127.0.0.1:8000",
    "https://mb-vogue.vendlyghana.space",
]
